...
export const themeImage = [
  { id: "1", icon: icon.theme1 },
  { id: "2", icon: icon.theme2 },
  { id: "3", icon: icon.theme3 },
  { id: "4", icon: icon.theme4 },
  { id: "5", icon: icon.theme5 },
  { id: "6", icon: icon.theme6 },
  { id: "7", icon: icon.theme7 },
  { id: "8", icon: icon.theme8 },
  { id: "9", icon: icon.theme9 },
];
